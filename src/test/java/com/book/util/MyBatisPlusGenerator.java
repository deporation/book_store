...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("deporation");// Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl(
                "jdbc:mysql://39.106.95.28:3306/BOOK_SYSTEAM?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.booksysteam.demo"); // 父级公用包名，就是自动生成的文件放在项目路径下的那个包中
        ...
        // Controller注解使用是否RestController标注,否则是否开启使用Controller标注
